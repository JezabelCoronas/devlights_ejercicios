...
//Tipos de datos. Declaración de variables. Conversiones. Operadores y expresiones.
...
int valorEntero = 123;
long valorCasteado = valorEntero; // Conversión implícita (de int a long)
...
//Ejemplo: de int a string y de string a int
string valorString = valorEntero.ToString(); // De int a string
int valorInt = int.Parse(valorString); // De string a int
...
var resto = 10 % 3; //El valor de resto es 1, ya que 10 dividido 3 es 3, y sobra 1
var division = 10 / 3; //El valor de división es 3.3333...
...
//Para mayor comprensión se recomienda usar paréntesis siempre
#endregion

//Estructuras básicas de control. Condicionales. Bucles.
...
//Ternario anidado
var resultado_ternario_anidado = (incremento % 2) == 0 ? "ES PAR" : (incremento % 3) == 0 ? "ES IMPAR" : "NO SE QUE ES";
Console.WriteLine(resultado_ternario_anidado);
